...
enum Tab: String, CaseIterable {
    ...
    var image: Image {
        let image: Image
        switch (self) {
        case .Home: image = Image(systemName: "house.fill")
        case .Cart: image = Image(systemName: "cart.fill")
        case .Liked: image = Image(systemName: "heart.fill")
        case .Profile: image = Image(systemName: "person.fill")
        }
        return image
    }
}
